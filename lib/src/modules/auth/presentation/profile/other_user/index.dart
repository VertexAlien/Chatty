...
import 'package:flutter_social_messenger/src/modules/subscriptions/data/sub_repo.dart';
                  ...
                  children: [
                    ...
                    Observer(
                      builder: (_) => UserList(
                        ...
                        key:
                            PageStorageKey('followers${user.followers.length}'),
                      ),
                    ),
                    Observer(
                      builder: (_) => UserList(
                        ...
                        key:
                            PageStorageKey('followers${user.following.length}'),
                      ),
                    ),
                  ],
                ),
