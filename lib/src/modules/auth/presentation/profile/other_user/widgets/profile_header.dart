...
import 'package:flutter_social_messenger/src/modules/subscriptions/presentation/index.dart';
...
class OProfileHeader extends StatelessWidget implements PreferredSizeWidget {
  ...
  const OProfileHeader(
      {Key key, @required this.controller, @required this.isSubscribed})
      : super(key: key);
                  ...
                  children: <Widget>[
                    ...
                    RaisedButton(
                      ...
                      onPressed: () => isSubscribed
                          ? ChatModule.toConversation(user.id)
                          : Navigator.push(
                              context,
                              MaterialPageRoute(
